    ...
    <div class="section">
        ...
        <div class="woocs__section-title woocs-mb-4">
            ...
            <?php if ($WOOCS->notes_for_free): ?>
                <?php if (time() > 1683526555 && time() < 1684015200): ?>
                    <div>
                        <br><a href="https://pluginus.net/affiliate/woocommerce-currency-switcher" target="_blank" class="woocs__button"><span class="icon-upload"></span><?php esc_html_e("Upgrade to Premium with 40% OFF until 14th May 2023", 'woocommerce-currency-switcher') ?></a>
                    </div>
                <?php endif; ?>
            <?php endif; ?>
