<?php
/**
 * Smartic_Product_Brand_List_Walker class
 *
 * @extends    Walker
 * @class        Smartic_Product_Brand_List_Walker
 * @version        2.3.0
...
if (!class_exists('Smartic_Product_Brand_List_Walker', false)) :

	class Smartic_Product_Brand_List_Walker extends Walker {
