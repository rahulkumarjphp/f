<?php
/**
 * Smartic WooCommerce Adjacent Products Class
 *
 * @package  smartic
 * @since    2.4.3
 */
...
if ( ! class_exists( 'Smartic_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The Smartic WooCommerce Adjacent Products Class
	 */
	class Smartic_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'smartic_woocommerce_adjacent_query_args', $args ) );
