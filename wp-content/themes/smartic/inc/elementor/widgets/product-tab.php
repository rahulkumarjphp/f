        ...
        <div class="elementor-tabs" role="tablist">
            <div class="elementor-tabs-wrapper">
				...
				foreach ( $tabs as $index => $item ) :
					...
					?>
                    <div <?php $this->print_render_attribute_string($tab_title_setting_key); // WPCS: XSS ok.
					?>><?php echo esc_html( $item['tab_title'] ); ?></div>
				<?php endforeach; ?>
            </div>
            <div <?php $this->print_render_attribute_string('data-carousel'); // WPCS: XSS ok.
			?>>
				<?php
				foreach ( $tabs as $index => $item ) :
					$tab_count = $index + 1;
					...
					?>
                    <div <?php $this->print_render_attribute_string($tab_content_setting_key); // WPCS: XSS ok.
					?>>
